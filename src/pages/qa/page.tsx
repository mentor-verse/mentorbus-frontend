...
export function QAPage() {
  ...
  const [searchBoxes, setSearchBoxes] = useState([
    { question: "고2 1학기를 망했는데..", 
      answer: "고1 1학기 때 3등급을 찍고, 2학기 때 2.4까지 올렸습니다. 근데 고2 1학기 때 너무 망해버려서 3.6까지 떨어져버렸어요...이거 남은 기간 동안 올리면 종합전형 쓸 수 있을까요? 아니면 정시로 갈아타야할까요?"
      , star_num: 1, comment_num: 1, type:'all', major: '공학계열' },
    { question: "숭실대 컴퓨터학부 VS 숭실대 AI융합학부", 
      answer: "고1 1학기 때 3등급을 찍고, 2학기 때 2.4까지 올렸습니다. 근데 고2 1학기 때 너무 망해버려서 3.6까지 떨어져버렸어요...이거 남은 기간 동안 올리면 종합전형 쓸 수 있을까요? 아니면 정시로 갈아타야할까요?"
      , star_num: 1, comment_num: 1, type:'all' , major: '인문계열'  },
    { question: "2.4 어문 교과", 
      answer: "고1 1학기 때 3등급을 찍고, 2학기 때 2.4까지 올렸습니다. 근데 고2 1학기 때 너무 망해버려서 3.6까지 떨어져버렸어요...이거 남은 기간 동안 올리면 종합전형 쓸 수 있을까요? 아니면 정시로 갈아타야할까요?"
      , star_num: 1, comment_num: 3, type:'all', major: '사회계열'  },
    { question: "이과 내신 2.9가 지원했을 때 가능성 있는 공과계열 인서울 학과", 
      answer: "고1 1학기 때 3등급을 찍고, 2학기 때 2.4까지 올렸습니다. 근데 고2 1학기 때 너무 망해버려서 3.6까지 떨어져버렸어요...이거 남은 기간 동안 올리면 종합전형 쓸 수 있을까요? 아니면 정시로 갈아타야할까요?"
      , star_num: 1, comment_num: 3, type:'all', major: '교육계열'  },
    { question: "컴공 생기부", 
      answer: "고1 1학기 때 3등급을 찍고, 2학기 때 2.4까지 올렸습니다. 근데 고2 1학기 때 너무 망해버려서 3.6까지 떨어져버렸어요...이거 남은 기간 동안 올리면 종합전형 쓸 수 있을까요? 아니면 정시로 갈아타야할까요?"
      , star_num: 1, comment_num: 2, type: 'all', major: '자연계열' },
    { question: "정시 백분위 컷 좀 알려주세요ㅠㅠ", 
      answer: "고1 1학기 때 3등급을 찍고, 2학기 때 2.4까지 올렸습니다. 근데 고2 1학기 때 너무 망해버려서 3.6까지 떨어져버렸어요...이거 남은 기간 동안 올리면 종합전형 쓸 수 있을까요? 아니면 정시로 갈아타야할까요?"
      , star_num: 1, comment_num: 2, type: 'all', major: '의학계열'},
  ]);
  ...
  const handleStarClick = (index: number, starred: boolean, star_num: number) => {
        ...
        <div className="main_content">
          <div style={{ background: '#fff' }}>
            ...
            <div className="flex justify-between mt-[40px]">
              ...
              <div className={`filter_btn_label ${filter === "written" ? 'active' : ''}`} onClick={() => setFilter("written")}>
                작성글
              </div>
            </div>
              ...
              {filteredBoxes.map((box, index) => (
                <div className="mt-[20px]" key={index}>
                  <QuestionBox
                    ...
                    onStarClick={(starred, star_num) => handleStarClick(index, starred, star_num)}
                  />
                </div>
              ))}
            </div>
