  ...
  ({ className, major, name, info, gen , ...props}, ref) => {
    ...
    return (
        <div className=" grid place-items-center">
            <div
                className={cn(" grid place-items-center w-40 h-48 p-2 border-[13px] border-white shadow-lg",
                    className,
                )}
                ref={ref}
                {...props}
            >
                ...
                <div className="text-gray-900 not-italic font-normal text-[8px] mt-[13px]">
                    {info}
                </div>
            </div>
        </div>
